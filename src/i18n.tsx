...
export const translations = {
  ar: {
    ...
    location: { title: 'موقعنا', subtitle: 'Aïn lala Mira, Sidi Bouzid, Safi', directions: 'احصل على الاتجاهات' },
  ...
  en: {
    ...
    location: { title: 'Location', subtitle: 'Aïn lala Mira, Sidi Bouzid, Safi', directions: 'Get Directions' },
  ...
  fr: {
    ...
    location: { title: 'Emplacement', subtitle: 'Aïn lala Mira, Sidi Bouzid, Safi', directions: 'Obtenir l\'itinéraire' },
